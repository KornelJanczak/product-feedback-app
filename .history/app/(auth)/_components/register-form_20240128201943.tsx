...
export default function RegisterForm() {
  ...
  return (
    <section className="container h-screen flex items-center justify-center pb-14 ">
      <Form {...form}>
        <form
        ...
        >
          <div className="flex justify-between items-center">
            ...
            <span
              className="text-lg text-secondDark cursor-pointer underline hover:transition duration-300"
