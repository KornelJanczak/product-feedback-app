  ...
  return (
    <header className="text relative">
      <ResponsiveImage
        ...
        pictureClassName="absolute w-full w-full object-cover mix-blend-overlay sm:h-16"
        imgClassName="absolute w-full h-16 sm:h-44 object-cover mix-blend-overlay"
